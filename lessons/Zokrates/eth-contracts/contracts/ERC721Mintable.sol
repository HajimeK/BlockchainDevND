...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), 'The given address should not be the owner of the tokenId');
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner() || isApprovedForAll(ownerOf(tokenId), msg.sender),
            'msg.sende should be the owner of the contract or isApprovedForAll() to be true');
        address oldOwner = _tokenApprovals[tokenId];
        // TODO add 'to' address to token approvals
        _tokenApprovals[tokenId] = to;
        // TODO emit Approval Event
        emit Approval(oldOwner, to, tokenId);
    }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId) || to != address(0), "revert if given tokenId already exists or given address is invalid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, 'require from address is the owner of the given token');

        // TODO: require token is being transfered to valid address
        require(address(0) != to, 'require token is being transfered to valid address');
