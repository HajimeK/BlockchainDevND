...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.name.call(), 'BlackHall');
    assert.equal(await instance.symbol.call(), 'ABC');
});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let startName = await instance.lookUptokenIdToStarInfo.call(starId);
    // 3. Verify if you Star name is the same
    assert(startName, 'awesome star 10');
});